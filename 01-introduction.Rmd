...
&emsp;&emsp;本书中我们的所有数据分析将基于R语言（https://cran.r-project.org/）。你在学习R语言的同时也将学习统计学。但是我们假设你已经具有一定的编程基础并且了解R语言基本语法。如果你尚不具备这些知识，我们建议你完成下面的教程。我们将手把手一步一步的教你建立和熟悉R环境。
...
第一步是R的安装。你可以从CRAN[Comprehensive R Archive Network]（https://cran.r-project.org/ ）免费下载和安装R。
