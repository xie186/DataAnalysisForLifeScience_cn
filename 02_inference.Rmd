...
>&emsp;&emsp; “相对正常喂养的老鼠（$+$ 0.2 $\pm$ 0.1 g; P < 0.001），喂养高脂饲料老鼠（$+$ 1.6 $\pm$ 0.1 g）的体重在一周后表现出体重的增加明显更多（P < 0.001）。”
...
&emsp;&emsp; P < 0.001的含义是什么？ $\pm$包含了什么内容？接下来你会学习这些内容，同时你也会学到如何在R中计算这些值。首先你要了解随机变量。
